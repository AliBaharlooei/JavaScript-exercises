...
let userInputName = document.getElementById("box-search__input");
let userSearchName = document.getElementById("box-search__btn");
let pname = document.getElementById("test");

userSearchName.onclick = () => {
    let userNameFind = userInputName.value;
    
    students.filter(element => {
        let isTrue = element.userName.startsWith(userNameFind);
        
        if(isTrue == true){
            console.log(element.userName);
            pname.innerText = element.userName
